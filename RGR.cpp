...
public:
	...
	//Конструкторы
    Vertex() : nameSet(false), dataSet(false) {} // по умолчанию
    Vertex(NameT name, DataT data) : name(name), data(data), nameSet(true), dataSet(true) {} // с  параментрами
...
public:
    //Конструкторы
    Edge(VertexT *v1, VertexT *v2) : v1(v1), v2(v2), weightSet(false), weight(0), dataSet(false) {} // не взвеш
    Edge(VertexT *v1, VertexT *v2, WeightT weight) : v1(v1), v2(v2), weight(weight), weightSet(true), dataSet(false) {} //взвеш
    Edge(VertexT *v1, VertexT *v2, WeightT weight, DataT data) : v1(v1), v2(v2), weight(weight), data(data), weightSet(true), dataSet(true) {} //взвеш с информ
...
public:
	...
	// ЗАДАНИЕ !!!!!!!!!!!!!!!!!!!!_______________________________________________________________________________________________________________________________________________________________
